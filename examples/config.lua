return {
  ...
  logger = {
    -- Which events are worthy of a message/mention in slack / discord
  ...
  messages = {
    -- Message templates for refunding scenarios, what you see here are the defaults
  ...
  items = {
    -- An array object of all the items you wish to sell
    {
      modid = "minecraft:dye",
      -- * The modid of the item you wish to sell (*Required)
    ...
    },
    {
      ...
      price = 50,
      predicate = {
        -- Predicates contain a template to match an item's metadata against
        enchantments = {
          {
            fullName = "Silk Touch"
          }
  ...
  example = {
    -- Example chest data to be used with layoutMode (xenon --layout)
